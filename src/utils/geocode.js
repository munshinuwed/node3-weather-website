...
const geocode = (address, callback) => {
      const url = 'https://api.mapbox.com/geocoding/v5/mapbox.places/' + encodeURIComponent(address) + '.json?access_token=pk.eyJ1IjoibnV3ZWQiLCJhIjoiY2ttdmhieXRhMDBxZDJvbXVnd2I1MHFkYyJ9.46tGExq1b20M0GNIqEcmfQ&limit=1'
